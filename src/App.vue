    ...
    <v-app id="inspire">
        <v-app-bar class="appbar" app clipped-right dark height="120">
            ...
            <v-btn v-if="!this.userIsAuthenticated" class="topnavbtn"
                   style="background: #424242;float:right;margin-right: 2%" @click="$router.push({name:'Registration'})"
            >Registration
            </v-btn
            >
            <v-btn v-if="!this.userIsAuthenticated" class="topnavbtn"
                   style="background: #424242;float:right;margin-right: 2%" @click="$router.push({name:'Login'})"
            >Login
            </v-btn>
            <v-icon v-if="this.userIsAuthenticated" class="profilicon" style="background: #424242;float: right"
