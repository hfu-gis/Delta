<template>
  <div>
    ...
    http://www.mysite.com (change this) (the "Site"). This page informs you of
    ...
    services in websites or apps, like Google Analytics. For the full disclosure
    ...
    <p></p>
    The Communications section is for businesses that may contact users via
    email (email newsletters) or other methods. For the full disclosure section,
    ...
    <p></p>
    This Privacy Policy is effective as of (add date) and will remain in effect
